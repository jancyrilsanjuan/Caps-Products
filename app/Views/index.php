...
<head>
  <meta charset="utf-8" />
  <title>Reviews & Ratings | Etour Guide: OrMin Travel Guide</title>
        ...
        <div class="row">
          <div class="col-sm-4 text-center">
            ...
            <h1 class="text-warning mt-4 mb-4">
              <b><span id="average_rating"><?=number_format($cc, 2)?></span> / 5.00</b>
            </h1>
            <h3><span id="total_review"><?=number_format($ccount['cc'], .1)?></span> Review</h3>
          </div>
          <div class="col-sm-4">
            <p>
          ...
          <div class="col-sm-4 text-center">
            ...
            if($logged):
              ?>
              <button onclick="hideButton(this)"type="button" name="add_review" id="add_review" class="btn btn-primary">Review</button>
            <?php else: ?>
            <?php endif; ?>
          </div>
        </div>
...
<?= $this->include('include/ratingscript')?>
