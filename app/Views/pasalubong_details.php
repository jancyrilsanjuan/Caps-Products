<title>Pasalubong Details | Etour Guide: OrMin Travel Guide</title>

<?= $this->include('include/top')?>

<style type="text/css">
#mydiv{
  background-image: url("<?= base_url('im/pasalubongcenter/') .  $name['image'] ?>");)
}
</style>
<body>
  ...
  <div class="bradcam_area bradcam_bg_4" style="background-image: url(../im/pasalubongcenter/<?=$locationImage;?>);">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <?php if($destinations):?>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_place">
            ...
            <div class="place_info">
              <a href="/test/<?=$des->id?>"><h3><?=$des->name?></h3></a>
