<title>Hotel Details  | Etour Guide: OrMin Travel Guide</title>

<?= $this->include('include/top')?>

<style type="text/css">
#mydiv {
  background-image: url("<?= base_url('im/hotel/') .  $name['image'] ?>");)
}
</style>
<body>
  ...
  <div class="bradcam_area bradcam_bg_4" style="  background-image: url(../im/hotel/<?=$locationImage;?>);">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <?php if($destinations):?>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-9">
          <!-- foreach -->
          <?php if($destinations):?>
            <?php foreach ($destinations as $aco): ?>
              <div class="single_destination">
                <h3>Location</h3>
                <i class="ti-pin mr-2"<p><?=$aco['location']?></p></i>
              </div>
              <br>
              <div class="single_destination">
                <h3>Directions</h3>
